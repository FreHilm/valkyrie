...
public class GameTypeStub
{
    ...
    public int defaultHeroes = 4;
    public float TilePixelPerSquare() { return pps; }
    public string TypeName() { return typeName; }
    public string DataDirectory() { return "/content"; }
    public int MaxHeroes() { return maxHeroes; }
    public int DefaultHeroes() { return defaultHeroes; }
}

public class D2EGameType : GameTypeStub { }
public class MoMGameType : GameTypeStub { }

public class QuestsManager
{
    public enum QuestListMode { ONLINE, OFFLINE }
    public QuestListMode quest_list_mode = QuestListMode.ONLINE;
}
...
public class Game
{
    ...
    public QuestsManager questsList = new QuestsManager();
