/**
 * The shipped slide-puzzle layouts, from `Assets/Resources/slidepuzzles.txt`.
 *
 * A slide puzzle is chosen from this set rather than generated, so a scenario
 * asking for one gets nothing at all without it — `PuzzleSlide.generate`
 * returns null, and the event then draws itself as an ordinary dialog with its
 * untranslated key on the button.
 *
 * Embedded rather than fetched: it is 8 KB of Valkyrie's own data, it never
 * changes, and a puzzle should not depend on a network round trip. The C#
 * reaches it through `Resources.Load("slidepuzzles")`.
 */

import { readFromString } from '../ini/IniRead.js'
import type { ContentFields } from '../content/types.js'

const SLIDE_PUZZLE_DATA = `[PuzzleSlide11]
moves=1
...
block1=False,2,0,3,4,False
block2=False,3,0,1,3,False
block3=False,2,0,2,0,False
block4=False,3,0,0,1,False
block5=False,1,0,1,4,False
block6=True,0,2,5,1,False
block7=True,0,2,0,3,False
...
block2=False,1,0,1,1,False
block3=True,0,2,4,0,False
block4=True,0,2,5,1,False
block5=False,1,0,1,4,False
block6=False,1,0,4,4,False
block7=True,0,1,2,2,False

[PuzzleSlide74]
moves=7
block0=False,1,0,0,2,True
block1=True,0,2,4,0,False
block2=False,1,0,0,0,False
block3=False,2,0,3,3,False
block4=True,0,2,5,0,False
block5=False,2,0,1,1,False
block6=True,0,1,0,4,False
block7=False,3,0,1,4,False


[PuzzleSlide75]
moves=7
block0=False,1,0,0,2,True
block1=False,1,0,0,3,False
block2=True,0,1,4,3,False
block3=False,2,0,1,0,False
block4=True,0,1,5,3,False
block5=True,0,1,5,1,False
block6=True,0,2,2,3,False
block7=True,0,1,1,4,False
block8=True,0,1,2,1,False

[PuzzleSlide81]
moves=8
block0=False,1,0,0,2,True
block1=True,0,2,5,1,False
block2=True,0,1,2,2,False
block3=True,0,1,0,0,False
block4=True,0,1,1,3,False
block5=True,0,1,3,2,False
block6=True,0,1,4,2,False
block7=False,3,0,2,4,False

[PuzzleSlide82]
moves=8
block0=False,1,0,0,2,True
block1=False,2,0,3,3,False
block2=True,0,1,5,1,False
block3=False,1,0,1,4,False
block4=True,0,1,0,3,False
block5=True,0,2,2,1,False
block6=False,1,0,0,1,False
block7=True,0,1,4,4,False

[PuzzleSlide83]
moves=8
block0=False,1,0,0,2,True
block1=True,0,1,3,4,False
block2=False,1,0,4,3,False
block3=True,0,1,0,4,False
block4=True,0,1,3,1,False
block5=False,1,0,4,4,False
block6=True,0,2,4,0,False
block7=False,1,0,1,3,False

[PuzzleSlide84]
moves=8
block0=False,1,0,0,2,True
block1=False,2,0,1,4,False
block2=False,3,0,1,1,False
block3=True,0,1,0,3,False
block4=True,0,1,5,2,False
block5=False,1,0,4,4,False
block6=False,3,0,0,0,False
block7=True,0,1,4,2,False
block8=True,0,1,3,2,False
...
block2=True,0,1,1,0,False
block3=True,0,1,0,0,False
block4=True,0,1,3,0,False
block5=True,0,2,5,3,False
block6=False,2,0,0,4,False

[PuzzleSlide91]
moves=9
block0=False,1,0,0,2,True
block1=True,0,2,2,0,False
block2=True,0,1,0,3,False
block3=False,2,0,1,4,False
block4=True,0,2,5,0,False
block5=True,0,1,3,0,False
block6=False,1,0,1,3,False
block7=False,1,0,3,3,False

[PuzzleSlide101]
moves=10
block0=False,1,0,0,2,True
block1=True,0,2,5,0,False
block2=False,1,0,4,3,False
block3=True,0,1,2,1,False
block4=False,2,0,1,0,False
block5=True,0,1,0,0,False
block6=True,0,1,4,1,False
block7=True,0,2,1,3,False
block8=False,3,0,2,4,False`

let parsed: ReadonlyMap<string, ContentFields> | null = null

/** The layouts, parsed once and shared. */
export function slidePuzzleLayouts(): ReadonlyMap<string, ContentFields> {
  parsed ??= readFromString(SLIDE_PUZZLE_DATA).data
  return parsed
}
